...
if($_POST["SET"]=="1" && $_POST["qid"]!="")
{
	...
	<tr>
		<td>
			...
			<div class="list">
<?			$chars_query = mysql_query("SELECT cid,char_name FROM characters");
...
elseif($_POST["SET"]=="2" && $_POST["qid"]!="" && $_POST["quest_name"]!="" && $_POST["old_ids"]!="" )
{
	...
	$log_string = "Admin Quest Members: " . $_POST["quest_name"] . " ";
...
<?		$quests_query = mysql_query("SELECT qid,quest_name,quest_status FROM quests WHERE post_access='MEMBERS'") or die ("error during your database query.[1]");
