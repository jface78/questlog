...
import (
    ...
    "encoding/hex"
    "strconv"
    "github.com/jonathanface/questlog/QuestListing"
    "github.com/jonathanface/questlog/Posts"
    "github.com/jonathanface/questlog/DBUtils"
    "github.com/jonathanface/questlog/Character"
    "github.com/jonathanface/questlog/User"
    "encoding/json"
    "strings"
    "math/rand"
    "time"
...
func handleUserInfo(w http.ResponseWriter, r *http.Request) {
  log.Println("handle user info")
  uid, err := strconv.Atoi(mux.Vars(r)["[0-9]+"])
  if (err != nil) {
    log.Fatal(err)
    badRequest(w, err.Error())
    return
  }
  var info = User.GetUserInfo(uid)
  jsonData, err := json.Marshal(info)
  if (err != nil) {
    serverError(w, err.Error())
    return
