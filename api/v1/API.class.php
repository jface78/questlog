      ...
      switch($this ->endpoint) {
        ...
        case 'quest':
          ...
          if ($this->method == 'GET') {
            ...
            $this -> args = array_change_key_case($this->request, CASE_UPPER);
            if (empty($this->args['BACKSTORY']) || empty($this->args['NAME'])) {
              return $this->_response("Invalid parameter(s)", 400);
            }
            ...
            parse_str($this -> file, $this->args);
            $this -> args = array_change_key_case($this->args, CASE_UPPER);
            if (empty($this->args['QID']) || !is_numeric($this->args['QID'])) {
              return $this->_response("Invalid parameter(s)", 400);
            }
          }
          break;
        ...
        case 'posts':
          if ($this->method == 'GET') {
            ...
            $this -> args = array_change_key_case($this->request, CASE_UPPER);
            if (empty($this->args['QID']) || empty($this->args['BODY'])) {
              return $this->_response("Invalid parameter(s)", 400);
            }
            if (!is_numeric($this->args['QID']) || !is_numeric($this->args['CID'])) {
              return $this->_response("Invalid parameter(s)", 400);
            }
          } else if ($this->method == 'DELETE') {
            if (!in_array('PID',$this->args)) {
            ...
            parse_str($this -> file, $this->args);
            $this -> args = array_change_key_case($this->args, CASE_UPPER);
            if (empty($this->args['PID']) || !is_numeric($this->args['PID'])) {
              return $this->_response("Invalid parameter(s)", 400);
            }
            if (empty($this->args['CID'])) {
              return $this->_response("Invalid parameter(s)", 400);
            }
